...
public class AssignmentIndexer extends BaseIndexer<Assignment> {
	...
	public boolean hasPermission(
		...
		Assignment assignment = _assignmentLocalService.getAssignment(
			entryClassPK);
	...
	@Override
	protected Document doGetDocument(Assignment assignment) throws Exception {
	...
	protected void reindexAssignments(long companyId) throws PortalException {
