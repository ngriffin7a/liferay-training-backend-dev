...
@Component(
	...
	service = SubmissionPermissionChecker.class
)
public class SubmissionPermissionCheckerImpl
	implements SubmissionPermissionChecker {

	@Override
	public void check(
			PermissionChecker permissionChecker, long groupId,
			long assignmentId, String actionId)
