...
public class SubmissionPersistenceImpl
	...
	/**
	 * Returns all the submissions that the user has permission to view where groupId = &#63;.
	 *
	 * @param groupId the group ID
	 * @return the matching submissions that the user has permission to view
	 */
	@Override
	public List<Submission> filterFindByGroupId(long groupId) {
		return filterFindByGroupId(
			groupId, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
	}

	/**
	 * Returns a range of all the submissions that the user has permission to view where groupId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to <code>QueryUtil#ALL_POS</code> will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent, then the query will include the default ORDER BY logic from <code>SubmissionModelImpl</code>.
	 * </p>
	 ...
	 * @param start the lower bound of the range of submissions
	 * @param end the upper bound of the range of submissions (not inclusive)
	 * @return the range of matching submissions that the user has permission to view
	 */
	@Override
	public List<Submission> filterFindByGroupId(
		long groupId, int start, int end) {
	...
	/**
	 * Returns an ordered range of all the submissions that the user has permissions to view where groupId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to <code>QueryUtil#ALL_POS</code> will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent, then the query will include the default ORDER BY logic from <code>SubmissionModelImpl</code>.
	 * </p>
	 ...
	 * @param end the upper bound of the range of submissions (not inclusive)
	 * @param orderByComparator the comparator to order the results by (optionally <code>null</code>)
	 * @return the ordered range of matching submissions that the user has permission to view
	 */
	@Override
	public List<Submission> filterFindByGroupId(
		long groupId, int start, int end,
		...
		if (getDB().isSupportsInlineDistinct()) {
			sb.append(_FILTER_SQL_SELECT_SUBMISSION_WHERE);
		}
		else {
			sb.append(_FILTER_SQL_SELECT_SUBMISSION_NO_INLINE_DISTINCT_WHERE_1);
		}

		sb.append(_FINDER_COLUMN_GROUPID_GROUPID_2);

		if (!getDB().isSupportsInlineDistinct()) {
			sb.append(_FILTER_SQL_SELECT_SUBMISSION_NO_INLINE_DISTINCT_WHERE_2);
		}
		...
		if (orderByComparator != null) {
			...
			if (getDB().isSupportsInlineDistinct()) {
				...
				sb.append(SubmissionModelImpl.ORDER_BY_SQL);
			}
		}

		String sql = InlineSQLHelperUtil.replacePermissionCheck(
			sb.toString(), Submission.class.getName(),
		...
		try {
			...
			if (getDB().isSupportsInlineDistinct()) {
				sqlQuery.addEntity(_FILTER_ENTITY_ALIAS, SubmissionImpl.class);
			}
			else {
				sqlQuery.addEntity(_FILTER_ENTITY_TABLE, SubmissionImpl.class);
			}
			...
			return (List<Submission>)QueryUtil.list(
	...
	/**
	 * Returns the submissions before and after the current submission in the ordered set of submissions that the user has permission to view where groupId = &#63;.
	 *
	 * @param submissionId the primary key of the current submission
	 * @param groupId the group ID
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 ...
	 */
	@Override
	public Submission[] filterFindByGroupId_PrevAndNext(
			long submissionId, long groupId,
			OrderByComparator<Submission> orderByComparator)
		throws NoSuchSubmissionException {
	...
	protected Submission filterGetByGroupId_PrevAndNext(
		Session session, Submission submission, long groupId,
		OrderByComparator<Submission> orderByComparator, boolean previous) {
		...
		List<Submission> list = sqlQuery.list();
	...
	/**
	 * Returns the number of submissions that the user has permission to view where groupId = &#63;.
	 *
	 * @param groupId the group ID
	 * @return the number of matching submissions that the user has permission to view
	 */
	@Override
	public int filterCountByGroupId(long groupId) {
		...
		sb.append(_FILTER_SQL_COUNT_SUBMISSION_WHERE);
	...
	/**
	 * Returns all the submissions that the user has permission to view where groupId = &#63; and assignmentId = &#63;.
	 *
	 * @param groupId the group ID
	 * @param assignmentId the assignment ID
	 * @return the matching submissions that the user has permission to view
	 */
	@Override
	public List<Submission> filterFindByG_A(long groupId, long assignmentId) {
		return filterFindByG_A(
			groupId, assignmentId, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
	}

	/**
	 * Returns a range of all the submissions that the user has permission to view where groupId = &#63; and assignmentId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to <code>QueryUtil#ALL_POS</code> will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent, then the query will include the default ORDER BY logic from <code>SubmissionModelImpl</code>.
	 * </p>
	 ...
	 */
	@Override
	public List<Submission> filterFindByG_A(
		long groupId, long assignmentId, int start, int end) {

		return filterFindByG_A(groupId, assignmentId, start, end, null);
	}

	/**
	 * Returns an ordered range of all the submissions that the user has permissions to view where groupId = &#63; and assignmentId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to <code>QueryUtil#ALL_POS</code> will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent, then the query will include the default ORDER BY logic from <code>SubmissionModelImpl</code>.
	 * </p>
	...
	/**
	 * Returns the submissions before and after the current submission in the ordered set of submissions that the user has permission to view where groupId = &#63; and assignmentId = &#63;.
	 *
	 * @param submissionId the primary key of the current submission
	 * @param groupId the group ID
	 * @param assignmentId the assignment ID
	 ...
	 */
	@Override
	public Submission[] filterFindByG_A_PrevAndNext(
			long submissionId, long groupId, long assignmentId,
			OrderByComparator<Submission> orderByComparator)
		throws NoSuchSubmissionException {
	...
	protected Submission filterGetByG_A_PrevAndNext(
		Session session, Submission submission, long groupId, long assignmentId,
		OrderByComparator<Submission> orderByComparator, boolean previous) {
	...
	/**
	 * Returns the number of submissions that the user has permission to view where groupId = &#63; and assignmentId = &#63;.
	 *
	 * @param groupId the group ID
	 * @param assignmentId the assignment ID
	 * @return the number of matching submissions that the user has permission to view
	 */
	@Override
	public int filterCountByG_A(long groupId, long assignmentId) {
		if (!InlineSQLHelperUtil.isEnabled(groupId)) {
			return countByG_A(groupId, assignmentId);
		}
	...
	public void clearCache(Set<Serializable> primaryKeys) {
		...
		for (Serializable primaryKey : primaryKeys) {
			entityCache.removeResult(
				entityCacheEnabled, SubmissionImpl.class, primaryKey);
		}
	}
	...
	private static final String _FILTER_SQL_SELECT_SUBMISSION_WHERE =
		"SELECT DISTINCT {submission.*} FROM Gradebook_Submission submission WHERE ";

	private static final String
		_FILTER_SQL_SELECT_SUBMISSION_NO_INLINE_DISTINCT_WHERE_1 =
			"SELECT {Gradebook_Submission.*} FROM (SELECT DISTINCT submission.submissionId FROM Gradebook_Submission submission WHERE ";

	private static final String
		_FILTER_SQL_SELECT_SUBMISSION_NO_INLINE_DISTINCT_WHERE_2 =
			") TEMP_TABLE INNER JOIN Gradebook_Submission ON TEMP_TABLE.submissionId = Gradebook_Submission.submissionId";

	private static final String _FILTER_SQL_COUNT_SUBMISSION_WHERE =
		"SELECT COUNT(DISTINCT submission.submissionId) AS COUNT_VALUE FROM Gradebook_Submission submission WHERE ";

	private static final String _FILTER_ENTITY_ALIAS = "submission";

	private static final String _FILTER_ENTITY_TABLE = "Gradebook_Submission";

	private static final String _ORDER_BY_ENTITY_ALIAS = "submission.";

	private static final String _ORDER_BY_ENTITY_TABLE =
		"Gradebook_Submission.";
