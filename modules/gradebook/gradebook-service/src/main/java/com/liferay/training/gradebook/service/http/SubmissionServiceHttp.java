...
public class SubmissionServiceHttp {
	...
	public static com.liferay.training.gradebook.model.Submission addSubmission(
		...
		try {
			...
			MethodHandler methodHandler = new MethodHandler(
				methodKey, submission, serviceContext);
	...
	public static com.liferay.training.gradebook.model.Submission
		createSubmission(HttpPrincipal httpPrincipal) {

		try {
			MethodKey methodKey = new MethodKey(
				SubmissionServiceUtil.class, "createSubmission",
				_createSubmissionParameterTypes1);
	...
	public static com.liferay.training.gradebook.model.Submission
		...
		try {
			MethodKey methodKey = new MethodKey(
				...
				_deleteSubmissionParameterTypes2);
	...
	public static com.liferay.training.gradebook.model.Submission
		...
		try {
			MethodKey methodKey = new MethodKey(
				...
				_updateSubmissionParameterTypes4);
	...
	public static java.util.List
		...
		try {
			MethodKey methodKey = new MethodKey(
				SubmissionServiceUtil.class, "getSubmissionsByKeywords",
				_getSubmissionsByKeywordsParameterTypes5);

			MethodHandler methodHandler = new MethodHandler(
				methodKey, groupId, assignmentId, keywords, start, end,
				orderByComparator);
	...
	public static long getSubmissionsCountByKeywords(
		...
		try {
			MethodKey methodKey = new MethodKey(
				SubmissionServiceUtil.class, "getSubmissionsCountByKeywords",
				_getSubmissionsCountByKeywordsParameterTypes6);

			MethodHandler methodHandler = new MethodHandler(
				methodKey, groupId, assignmentId, keywords);
	...
	private static final Class<?>[] _addSubmissionParameterTypes0 =
		new Class[] {
			com.liferay.training.gradebook.model.Submission.class,
			com.liferay.portal.kernel.service.ServiceContext.class
		};
	private static final Class<?>[] _createSubmissionParameterTypes1 =
		new Class[] {};
	private static final Class<?>[] _deleteSubmissionParameterTypes2 =
		new Class[] {long.class};
	private static final Class<?>[] _getSubmissionParameterTypes3 =
		new Class[] {long.class};
	private static final Class<?>[] _updateSubmissionParameterTypes4 =
		new Class[] {
			com.liferay.training.gradebook.model.Submission.class,
			com.liferay.portal.kernel.service.ServiceContext.class
		};
	private static final Class<?>[] _getSubmissionsByKeywordsParameterTypes5 =
		new Class[] {
			long.class, long.class, String.class, int.class, int.class,
			com.liferay.portal.kernel.util.OrderByComparator.class
		};
	private static final Class<?>[]
		_getSubmissionsCountByKeywordsParameterTypes6 = new Class[] {
