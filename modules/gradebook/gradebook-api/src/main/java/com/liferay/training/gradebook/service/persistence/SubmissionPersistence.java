...
public interface SubmissionPersistence extends BasePersistence<Submission> {
	 ...
	 */
	public java.util.List<Submission> filterFindByGroupId(long groupId);
	 ...
	 */
	public java.util.List<Submission> filterFindByGroupId(
		long groupId, int start, int end);
	 ...
	 * @return the matching submissions that the user has permission to view
	 */
	public java.util.List<Submission> filterFindByG_A(
		long groupId, long assignmentId);
