...
public class SubmissionUtil {
	 ...
	 */
	public static List<Submission> filterFindByGroupId(long groupId) {
	 ...
	 */
	public static List<Submission> filterFindByGroupId(
		long groupId, int start, int end) {
	 ...
	 * @throws NoSuchSubmissionException if a submission with the primary key could not be found
	 */
	public static Submission[] filterFindByGroupId_PrevAndNext(
			long submissionId, long groupId,
			OrderByComparator<Submission> orderByComparator)
		throws com.liferay.training.gradebook.exception.
			NoSuchSubmissionException {
	 ...
	 * @return the matching submissions that the user has permission to view
	 */
	public static List<Submission> filterFindByG_A(
		long groupId, long assignmentId) {

		return getPersistence().filterFindByG_A(groupId, assignmentId);
	}
	 ...
	 * @throws NoSuchSubmissionException if a submission with the primary key could not be found
	 */
	public static Submission[] filterFindByG_A_PrevAndNext(
			long submissionId, long groupId, long assignmentId,
			OrderByComparator<Submission> orderByComparator)
		throws com.liferay.training.gradebook.exception.
			NoSuchSubmissionException {
	 ...
	 * @return the number of matching submissions that the user has permission to view
	 */
	public static int filterCountByG_A(long groupId, long assignmentId) {
		return getPersistence().filterCountByG_A(groupId, assignmentId);
	}
	...
	public static List<Submission> findByStudentId(
		...
		return getPersistence().findByStudentId(
			studentId, start, end, orderByComparator, retrieveFromCache);
	}
